...
st.set_page_config(
    page_title="StressIQ - Recruiter Dashboard",
    page_icon="👥",
    layout="wide"
)
...
<style>
    ...
    [data-testid="stAppViewContainer"] {
        background: linear-gradient(180deg, #FFE6E6 0%, #B5C1E8 33%, #8B9BD9 66%, #1E2B6B 100%);
    }
    
    /* Text alignment - everything left by default */
    ...
    .stButton > button {
        ...
        background-color: #1E2B6B !important;
    ...
    .stButton > button:hover {
        background-color: #8B9BD9 !important;
    }
    ...
    .stTextArea > div > div > textarea {
        border-radius: 4px !important;
        border: 1px solid #8B9BD9 !important;
    ...
    .card {
        ...
        padding: 20px;
        margin: 10px 0;
        border: 1px solid rgba(139, 155, 217, 0.2);
    }
...
if not firebase_admin._apps:
    cred = credentials.Certificate(r"assessai-44afc-firebase-adminsdk-fbsvc-4e13d0986d.json")
...
def setup_google_sheets_api():
    ...
    credentials = service_account.Credentials.from_service_account_file(
        r"D:\projects\deployment\moonlit-haven-452014-i4-248bff09d735.json",  # Replace with your file path
